...
/**
 * REST controller for managing {@link et.com.hahu.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class CustomPostResource {

    private final Logger log = LoggerFactory.getLogger(CustomPostResource.class);
    ...
    public CustomPostResource(PostService postService, UserService userService, PostQueryService postQueryService) {
    ...
    public ResponseEntity<PostDTO> createPost(@RequestBody PostDTO postDTO) throws URISyntaxException {
        ...
        if (SecurityUtils.getCurrentUserLogin().isPresent()) {
            ...
            postDTO.setUserLogin(userDTO.getLogin());
            postDTO.setUserId(userDTO.getId());
            postDTO.setModifiedDate(Instant.now());
            postDTO.setPostedDate(Instant.now());
        }

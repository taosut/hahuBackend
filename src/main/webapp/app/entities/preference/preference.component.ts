...
export class PreferenceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.preferenceService
      ...
      .subscribe(
        (res: HttpResponse<IPreference[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IPreference[] | null, headers: HttpHeaders, page: number): void {

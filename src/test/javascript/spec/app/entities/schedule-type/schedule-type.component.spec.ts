...
import { ScheduleTypeComponent } from 'app/entities/schedule-type/schedule-type.component';
...
describe('Component Tests', () => {
  describe('ScheduleType Management Component', () => {
    let comp: ScheduleTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ScheduleTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.scheduleTypes && comp.scheduleTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

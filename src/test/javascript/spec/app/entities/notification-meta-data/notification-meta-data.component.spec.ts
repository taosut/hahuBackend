...
import { NotificationMetaDataComponent } from 'app/entities/notification-meta-data/notification-meta-data.component';
...
describe('Component Tests', () => {
  describe('NotificationMetaData Management Component', () => {
    let comp: NotificationMetaDataComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NotificationMetaDataComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new NotificationMetaData(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.notificationMetaData && comp.notificationMetaData[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

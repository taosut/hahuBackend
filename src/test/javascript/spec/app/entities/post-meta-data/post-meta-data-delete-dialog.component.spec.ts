...
import { PostMetaDataDeleteDialogComponent } from 'app/entities/post-meta-data/post-meta-data-delete-dialog.component';
import { PostMetaDataService } from 'app/entities/post-meta-data/post-meta-data.service';

describe('Component Tests', () => {
  describe('PostMetaData Management Delete Component', () => {
    let comp: PostMetaDataDeleteDialogComponent;
    let fixture: ComponentFixture<PostMetaDataDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .compileComponents();
      fixture = TestBed.createComponent(PostMetaDataDeleteDialogComponent);

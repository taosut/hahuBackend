...
import { ViewsComponent } from 'app/entities/views/views.component';
import { ViewsService } from 'app/entities/views/views.service';
import { Views } from 'app/shared/model/views.model';

describe('Component Tests', () => {
  describe('Views Management Component', () => {
    let comp: ViewsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ViewsComponent, '')
        .compileComponents();
